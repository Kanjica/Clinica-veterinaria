...
public class LoginTutor extends javax.swing.JPanel {
    ...
    public LoginTutor(Clinica clinica) {
        initComponents();
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(acessar, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(19, 19, 19))
                            .addComponent(campoCpf, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel28)
                                .addGap(18, 18, 18)
                                .addComponent(campoNome, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(6, 6, 6))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(40, 40, 40)
    ...
    private void acessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acessarActionPerformed
       ...
       if (cpfDigitado.isEmpty() || nomeTexto.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Preencha todos os campos!");
        return;
        }
       
        Tutor dono = validarLoginTutor(cpfDigitado,nomeTexto);
        if(dono == null){
          JOptionPane.showMessageDialog(this, "Tutor nao encontrado, se cadastre no sistema ou tente novamente!");
          return;
        }
    ...
    private Tutor validarLoginTutor(String cpfDigitado, String nomeTexto) {

    Tutor dono = petShop.buscarTutorPorNome(nomeTexto);

    if (dono != null && dono.getCpf().equals(cpfDigitado)) {
        JOptionPane.showMessageDialog(this, "Login realizado com sucesso! Bem-vindo(a), " + dono.getNome());
        return dono;
    } else {
        return null;
    }
