...
public class ListarVacinas extends javax.swing.JPanel {

   
    private Clinica clinica;
    public ListarVacinas(Clinica clinica) {
        initComponents();
        this.clinica = clinica;
        jTextArea1.setForeground(Color.decode("#E6E51D"));
        listarVacinas(); // preenche na criação
    }
    
    private void listarVacinas(){
        jTextArea1.setText("");//limpar
        for(Vacina vacina: clinica.getListaVacinas()){
            jTextArea1.append(
            vacina +
            "\n\t--------------------------------------------------------------------------------------------------\n"
        );
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Listar Vacinas");
    ...
    private void voltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_voltarActionPerformed
        ...
        GerenciaVacinas painel = new GerenciaVacinas(clinica);
        frame.add(painel);
